	...
	return (
		<div>
			<p
				...
				className="relative left-1/2 -translate-x-1/2 w-max mb-6 leading-[70px] tracking-[2.9px] text-surface/20 text-center whitespace-nowrap [-webkit-text-stroke:2px_var(--accent)] [text-shadow:0_0_10px_color-mix(in_oklab,var(--accent)_5%,transparent)] font-bold font-tektur"
			>
				{activeSlide.label}
			</p>
